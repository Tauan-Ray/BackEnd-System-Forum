...
export class AuthService {
    ...
    async signIn (email: string, password: string) {
        ...
        const tokens = await this.getTokens({ sub: user.ID_USER, username: user.USERNAME, role: user.ROLE, email: user.EMAIL })
    ...
    async refreshToken (rt: string) {
        ...
        const token = await this.getTokens({ sub: decodedRefreshToken.sub, username: decodedRefreshToken.username })
